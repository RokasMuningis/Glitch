...
class Glitches {
  ...
  private compOp: "lighter" | "darker" | "xor";
  private scanlineRange: number;
  private scanlineBase: number;
  private glitchThreshold: number;
  private glitchAmplitude: number;
  private alphaMin: number;
  private amplitudeRange: number;
  private amplitudeBase: number;
  private amplitude: number;
  private phaseStep: number;
  private phase: number;
  private scanlineShift: number;
